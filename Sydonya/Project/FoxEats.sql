...
('Beef Tacos', 5.99, 'Spicy beef tacos with salsa and cheese', 'Mexican', 'Bush Cafe'),
('Butter Chicken', 10.99, 'Creamy butter chicken served with rice', 'Indian', 'Bush Cafe'),
('Cheese Pizza', 8.99, 'Classic cheese pizza with marinara sauce', 'Italian', 'Daves Boathouse'),
('Chicken Salad', 6.99, 'Grilled chicken salad with mixed greens', 'Healthy', 'Daves Boathouse'),
('Chocolate Cake', 4.99, 'Rich chocolate cake with fudge icing', 'Dessert', 'Lakeside Grill'),
('Falafel Wrap', 6.99, 'Falafel with hummus and veggies in a wrap', 'Middle Eastern', 'Lakeside Grill'),
('Pad Thai', 8.99, 'Stir-fried noodles with shrimp and peanuts', 'Thai', 'Lakeside Cafe'),
('Pulled Pork Sandwich', 7.99, 'Slow-cooked pulled pork with BBQ sauce', 'American', 'Lakeside Cafe'),
('Sushi Roll', 9.99, 'Fresh salmon sushi roll with avocado', 'Japanese', 'C-Store'),
('Veggie Burger', 7.99, 'Plant-based burger with lettuce and tomato', 'American', 'C-Store');
