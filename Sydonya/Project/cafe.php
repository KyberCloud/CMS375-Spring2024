...
$query = "SELECT Food_Option, Food_Description, Price FROM Food LIMIT 6, 2"; // Skip the first 6 items and select the next 2
...
<head>
    ...
    <title>Lakeside Cafe Menu | FoxEats</title>
    <style>
        body {
